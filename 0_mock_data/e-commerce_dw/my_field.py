...
CHANNEL_LIST = ['天猫', '京东', '苏宁', '拼多多', '淘宝', '国美']

STORE_LIST = ['自营店', '加盟店', '授权店']

PRODUCT_LIST = ["电子书刊", "音像", "英文原版", "文艺", "少儿", "人文社科", "经管励志",
                "生活", "科技", "教育", "港台图书"]

CHANNEL_LIST_MENGNIU = ['所有渠道', '天猫', '京东']

DEPARTMENT_LIST = ['常温事业部', '低温事业部', '冰品事业部', '鲜奶事业部', '奶酪事业部',
                   'testdelete']

CENTER_LIST = ['常温-市场管理一中心', '常温-市场管理二中心', '低温-市场管理中心',
               '冰品-市场管理中心', '奶酪-爱氏晨曦零食', 'A', 'B']

GROUP_LIST = ['常温-高端品牌部', '常温-创新品牌部', '常温-功能品牌部', '常温-白奶品牌部',
              '常温-花色奶品牌部', '常温-纯甄品牌部', '常温-基础乳饮料品牌部',
              '常温-高端乳饮料品牌部', '常温-奶特&风味饮料',
              '常温-创新饮料', '低温-高端品类部', '低温-冠益乳品牌部', '低温-优益C品牌部',
              '低温-冠益乳及创新品类部', '低温-高端酸奶部', '低温-乳酸菌饮料部',
              '低温-蒙牛酸奶一部', '低温-蒙牛酸奶二部', '低温-蒙牛酸奶三部',
              '冰品-冰与品牌组', '冰品-随变品牌部', '冰品-蒂兰圣雪品牌部',
              '冰品-绿色心情品牌组', '冰品-基础品牌组', '奶酪-进口品及奶酪生活品类',
              '奶酪-休闲享受（儿童）业务组',
              '奶酪-休闲享受（成人）业务组',
              '奶酪-奶酪生活业务组', '奶酪-营养健康业务组', '奶酪-佐餐美食业务组', 'A1']

BRAND_LIST = ['常温-特仑苏', '新养道', '焕轻', '未来星', '现代牧业', '常温-蒙牛',
              '早餐奶', '纯甄', '酸酸乳', 'Go畅', '真果粒', '奶特', '慢燃', '凝纯',
              '晚上好', '冠益乳', '低温-特仑苏', '优益C', '北欧芝士', '低温-蒙牛',
              '中华滋养', '欧式炭烧', '冰+', '随变', '蒂兰圣雪', '绿色心情', '冰品-蒙牛']
